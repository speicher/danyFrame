...
frozenColJsonList:表格的冻结列，滚动条滚动时不包括这些冻结列
...
singleEditing:表示是否在一个时刻只允许一行数据开启编辑状态(当某行数据开启编辑状态时，其他正在编辑的行将会被自动执行 endEdit 操作)
-->
<#macro datagrid
	id="id" name="" title="" columnsJsonList="[]" frozenColJsonList="[]" jsonExtend="{}" loadUrl="" saveUrl=""   defaultColumn=""  
	isHasToolBar="true"  divToolbar=""  height="" width="" onClickRowEdit="true" pageSize='10'  singleSelect="true" 
	pagination="true" rownumbers="false" onClickRowAuto="true" fit="" idField="" reduceHeight=0 onRowContextMenuDivId="" 
	checkOnSelect="false"  selectOnCheck="false" fitColumns="false" enableHeaderClickMenu="true" enableHeaderContextMenu="true" emptyMsg="暂无数据"  border="false" 
	dndRow="false" singleEditing="false" keyboard="true" lastFn="" pageList="[10,20,50,100,200,300,400,500]" showFooter="false">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var $dgExtend={
            ...
            emptyMsg:"${emptyMsg}",
            frozenColumns : [ ${frozenColJsonList}],
